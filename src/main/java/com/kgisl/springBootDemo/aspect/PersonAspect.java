package com.kgisl.springBootDemo.aspect;
...
@Aspect
@Component
public class PersonAspect implements ThrowsAdvice{
    Logger LOGGER = LoggerFactory.getLogger(this.getClass());

    // private Logger LOGGER = Logger.getLogger(this.getClass());


    @Pointcut("execution(* com.kgisl.springBootDemo.service.*.*(..))")
    ...
    @Before("execution(* com.kgisl.springBootDemo.service.*.*(..))")
...
@AfterThrowing(pointcut="execution(* com.kgisl.springBootDemo.controller.*.*(..))", 
        throwing="excep")
